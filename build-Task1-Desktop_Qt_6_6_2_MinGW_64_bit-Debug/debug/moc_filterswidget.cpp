...
struct qt_meta_stringdata_CLASSFiltersWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFiltersWidgetENDCLASS = QtMocHelpers::stringData(
    "FiltersWidget",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFiltersWidgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFiltersWidgetENDCLASS_t qt_meta_stringdata_CLASSFiltersWidgetENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFiltersWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FiltersWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSFiltersWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSFiltersWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFiltersWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *FiltersWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSFiltersWidgetENDCLASS.stringdata0))
